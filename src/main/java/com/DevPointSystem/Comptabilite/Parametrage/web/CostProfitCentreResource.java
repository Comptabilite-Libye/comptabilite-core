...
import com.DevPointSystem.Comptabilite.Parametrage.service.CostProfitCentreService;
import java.net.URI;
...
//    
    ...
    @DeleteMapping("cost_center/delete/{code}")
    ...
    @GetMapping("cost_center/findByCodesIn")
    ...
    @GetMapping("cost_center/findByCodeSaisieBetween")
