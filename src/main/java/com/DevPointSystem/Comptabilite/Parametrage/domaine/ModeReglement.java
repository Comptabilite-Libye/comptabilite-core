...
public class ModeReglement {
    ...
    @Column(name = "req_banque", nullable = false)
    private boolean reqBanque;
    ...
    public boolean isReqBanque() {
        return reqBanque;
    }

    public void setReqBanque(boolean reqBanque) {
        this.reqBanque = reqBanque;
    }
