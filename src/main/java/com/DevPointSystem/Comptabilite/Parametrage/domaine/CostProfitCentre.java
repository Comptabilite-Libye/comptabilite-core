...
//    @JoinColumn(name = "Code_Pere", referencedColumnName = "Code", nullable = true)
//    @ManyToOne
//    @Fetch(FetchMode.SELECT)
//    private CostProfitCentre codePere;
    
  
    

    @JoinColumn(name = "Type_profit_centre", referencedColumnName = "Code", nullable = false)
    @ManyToOne(optional = false, fetch = FetchType.LAZY)
    @JsonBackReference
    private TypeCostCentre typeCostCentre;

    @Column(name = "Type_profit_centre", updatable = false, insertable = false, nullable = false)
