...
//			}
            ...
            for (final Map.Entry<String, String> entry : ((Map<String, String>) registrationBean.getInitParameters()).entrySet()) {
                filterRegistration.setInitParameter(entry.getKey(), entry.getValue());
            }
        }
...
//	}
    ...
    /**
     * Monitoring of beans and methods having the {@link MonitoredWithSpring}
     * annotation.
     *
    ...
    /**
     * Monitoring of beans methods having the {@link Scheduled} or
     * {@link Schedules} annotations.
     *
     * @return MonitoringSpringAdvisor
     */
    //	@Bean
    ...
    @Bean(name = "javamelodyRegistration")
    public FilterRegistrationBean<MonitoringFilter> javamelodyRegistration() {
        FilterRegistrationBean<MonitoringFilter> registration = new FilterRegistrationBean<>(new MonitoringFilter());
        registration.setName("javamelody-registration");
